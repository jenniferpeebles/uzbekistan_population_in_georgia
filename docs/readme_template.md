...
The uncertainty matters! Keep the margin of error beside the estimate whenever you share it. These data describe **{{PERIOD}}**, not a head count on Independence Day.
...
Generated from the project outputs on {{RUN_DATE}}. Human editorial review is still needed before publication.
