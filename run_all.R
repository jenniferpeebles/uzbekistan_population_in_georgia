...
# Inputs: configured packages and Census key. Outputs: data, QA, maps, brief, README.
...
pipeline_scripts <- c("01_variable_reconnaissance.R", "02_download_and_prepare.R",
                      ...
                      "05_country_facts.R", "06_reporter_brief_readme.R")
for (script in pipeline_scripts) {
  message("RUNNING: ", script)
  source(file.path("scripts", script), local = new.env(parent = globalenv()))
}
message("Complete. Review README.md, outputs/reporter_brief.md and outputs/qa_summary.csv before publication.")
